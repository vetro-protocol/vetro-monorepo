...
import { requestWithdraw } from "../../src/actions/wallet/requestWithdraw.ts";
...
describe("requestWithdraw", function () {
  ...
  it("should emit 'request-withdraw-failed-validation' if vault address is invalid", async function () {
    const parameters = {
      ...validParameters,
